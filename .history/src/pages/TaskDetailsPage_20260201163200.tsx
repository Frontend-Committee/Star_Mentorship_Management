...
import { CalendarDays, CheckCircle2, Clock, ExternalLink, FileText, Loader2, MessageSquare } from 'lucide-react';
...
export default function TaskDetailsPage() {
  ...
  const { data: memberSubmissions, isLoading: isMemberSubsLoading } = useMemberSubmissions({ enabled: !isAdmin , id: taskId });
  
  // For member, find their specific submission for this task
  const mySubmission = !isAdmin && memberSubmissions 
    ? memberSubmissions.find(s => s.task === taskId) 
    : null;
