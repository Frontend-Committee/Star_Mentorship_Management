  ...
  return useMutation({
    mutationFn: async (data: RegisterPayload) => {
      try {
        ...
        // Check if response data contains email error array (Djoser/DRF sometimes returns 200/201 but with errors in body if configured weirdly, but usually 400)
...
export const useUsers = () => {
  return useQuery({
    ...
    queryFn: async () => {
      ...
      // Handle potential pagination (DRF standard)
